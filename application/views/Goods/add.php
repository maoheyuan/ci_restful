        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span12 column" style="margin-left: 30px;margin-top: 20px;">
                    ...
                    <?php echo form_open_multipart('/Goods/add',array("class"=>"inline-input")) ?>
                    ...
                    <div class="span12 field-box textarea">
                        <label>介简:</label>
                        <input class="span10" type="text"  name="discription" value="<?php echo set_value('discription'); ?>"/>
                        <div class="errortip"><?php echo form_error('discription'); ?></div>
                    </div>

                    <div class="span12 field-box">
                        <label>市场价:</label>
                        <input class="span10" type="text" name="market_price" value="<?php echo set_value('market_price'); ?>"/>
                        <div class="errortip"><?php echo form_error('market_price'); ?></div>
                    </div>
                    <div class="span12 field-box">
                        <label>销售价:</label>
                        <input class="span10" type="text" name="sales_price" value="<?php echo set_value('sales_price'); ?>"/>
                        <div class="errortip"><?php echo form_error('sales_price'); ?></div>
                    </div>

                    <div class="span12 field-box">
                        <label>	库存:</label>
                        <input class="span10" type="text" name="stock" value="<?php echo set_value('stock'); ?>" />
